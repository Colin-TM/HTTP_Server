...
public class Parser {
     ...
     */
    public static HashMap<String, String> checkRequestLine(BufferedReader clientReader) {
     ...
     */
    public static Request parseRequest(BufferedReader clientReader, HashMap<String,String> details)
            throws IOException {
